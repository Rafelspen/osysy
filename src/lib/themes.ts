...
export type ThemeId = "hydro" | "tidal" | "abyss" | "holo" | "biolume" | "classic";
...
export const THEMES: ThemeMeta[] = [
  ...
  { id: "holo", label: "Aquatic Hologram", bodyClass: "holo", swatch: "linear-gradient(135deg, #55e8ff, #9b8bff 50%, #ff9cf2 85%)" },
  { id: "biolume", label: "Bioluminescent Deep", bodyClass: "biolume", swatch: "linear-gradient(135deg, #58ffc9, #33d9ff 55%, #02100f)" },
